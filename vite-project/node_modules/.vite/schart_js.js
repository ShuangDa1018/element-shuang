    ...
    !function(t, i) {
      ...
      return function() {
        ...
        return function(t, i, e2) {
          ...
          var t = this.ctx;
          t.beginPath(), t.font = 12 * f + "px Microsoft YaHei", t.textAlign = this.xRorate ? "right" : "center", t.textBaseline = "top", t.fillStyle = this.axisColor;
          for (var i = 0; i < this.labels.length; i++) {
            var e2 = this.labels[i], a2 = this.leftPadding + this.xLength * (i + 1) + 0.5, s = this.canvas.height - this.bottomPadding;
            this.showGrid ? (t.strokeStyle = this.gridColor, t.moveTo(a2, s), t.lineTo(a2, this.topPadding + g)) : (t.moveTo(a2, s), t.lineTo(a2, s - u)), t.stroke(), t.save(), t.translate(a2 - this.xLength / 2, s + u), t.rotate(-this.xRorate * Math.PI / 180), t.fillText(e2, 0, 0), t.restore();
          }
